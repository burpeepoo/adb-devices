# Graph Report - /Users/kaizhang/Documents/Cozyla/adb_project  (2026-04-29)

## Corpus Check
- 89 files · ~81,084 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 253 nodes · 422 edges · 13 communities detected
...
8. `main()` - 7 edges
9. `emit_install_progress()` - 7 edges
10. `install_scrcpy()` - 6 edges
...
- `get_adb_path()` --calls--> `adb_start_recording()`  [INFERRED]
  /Users/kaizhang/Documents/Cozyla/adb_project/src-tauri/src/adb.rs → /Users/kaizhang/Documents/Cozyla/adb_project/src-tauri/src/commands/record.rs
- `env()` --calls--> `run_adb_with_env()`  [INFERRED]
  /Users/kaizhang/Documents/Cozyla/adb_project/scripts/send-lark-release.mjs → /Users/kaizhang/Documents/Cozyla/adb_project/src-tauri/src/adb.rs
...
Cohesion: 0.13
Nodes (23): adb, ensure_success(), run_adb(), apphandle, adb_input_text(), escape_adb_input_text(), local, send_navigation_key() (+15 more)

### Community 3 - "Community 3"
Cohesion: 0.15
Nodes (21): run_adb_with_timeout(), adb_auto_connect(), adb_connect(), adb_devices(), adb_disconnect(), adb_mdns_auto_connect(), adb_mdns_discover(), adb_pair() (+13 more)
...
Cohesion: 0.23
Nodes (13): AdbError, build_adb_command(), check_adb_available(), ensure_executable(), get_adb_path(), get_bundled_adb_path(), get_sdk_adb_path(), get_system_adb_path() (+5 more)
...
Cohesion: 0.24
Nodes (8): io, adb_read_logcat(), adb_start_logcat(), append_filter_args(), LogcatEntry, parse_logcat_line(), process, thread
...
## Knowledge Gaps
- **11 isolated node(s):** `HTML Entry Point`, `Windows Tile Icons`, `iOS App Icon Set`, `Android Launcher Icons`, `DeviceInfo` (+6 more)
...
- **Why does `env()` connect `Community 6` to `Community 1`, `Community 5`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `start_screen_mirror()` connect `Community 1` to `Community 5`, `Community 6`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `ensure_success()` connect `Community 2` to `Community 8`, `Community 1`, `Community 3`, `Community 5`?**
