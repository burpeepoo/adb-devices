...
## Corpus Check
- 29 files · ~14,907 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 98 nodes · 112 edges · 8 communities detected
...
6. `adb_list_package_details()` - 5 edges
7. `read_u16()` - 5 edges
8. `adb_list_packages()` - 4 edges
9. `extract_apk_package_name()` - 4 edges
10. `parse_start_element_package()` - 4 edges
...
- **Why does `ensure_success()` connect `Community 3` to `Community 2`?**
