  ...
  return (
    <div className="flex items-center justify-center h-screen bg-gray-50">
      <div className="bg-white rounded-xl shadow-lg p-8 max-w-md w-full text-center">
        ...
        <h2 className="text-xl font-semibold text-gray-800 mb-2">ADB 未安装</h2>
        <p className="text-gray-500 mb-6">
          ADB (Android Debug Bridge) 是连接和管理 Android 设备的必要工具。
          <br />点击下方按钮一键安装。
        </p>
        ...
        <div className="mt-6 text-xs text-gray-400 text-left">
          <p className="font-medium mb-1">也可以手动安装:</p>
          <p>macOS: <code className="bg-gray-100 px-1 rounded">brew install --cask android-platform-tools</code></p>
          <p className="mt-1">Windows: 从 Android 开发者官网下载 Platform Tools</p>
        </div>
      </div>
    </div>
  );
