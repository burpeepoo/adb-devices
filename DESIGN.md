...
This project applies Cirrus to a dense desktop operations tool rather than to a marketing page. Keep the open-sky canvas, Cloud floating surfaces, Ink active states, Edge hairlines, pill controls, and soft Tier 1/2 shadows, but do not add hero marketing sections to the app shell. The first screen remains the actual ADB workspace.
